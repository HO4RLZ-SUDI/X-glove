...
// ESP32-C3 + OLED glove enclosure - masterpiece edition
// Units: millimeters
...
corner_r = 5.0;
inner_r = 3.1;
body_bottom_chamfer = 0.75;
body_top_chamfer = 1.05;
body_face_inset = 0.85;
lid_bottom_chamfer = 0.50;
lid_top_chamfer = 0.80;
lid_face_inset = 0.65;
skin = 0.04;
...
mount_H = 3.0;
mount_r = 8.0;
mount_bottom_chamfer = 0.70;
mount_top_chamfer = 0.60;
mount_face_inset = 0.50;
mount_x = (L - mount_L) / 2;
mount_y = (W - mount_W) / 2;

velcro_w = 22.0;
velcro_clearance = 2.8;
velcro_slot_L = velcro_w + velcro_clearance;
velcro_slot_W = 5.4;
velcro_slot_r = 1.45;
velcro_slot_edge = 9.0;
velcro_channel_depth = 1.20;
velcro_channel_clearance = 2.0;

glove_sew_slot_L = 11.5;
glove_sew_slot_W = 3.4;
glove_sew_slot_r = 1.25;
glove_sew_slot_x = 5.0;
glove_sew_slot_y_offset = 11.5;

glove_lace_hole_d = 2.2;
glove_lace_edge_x = 16.0;
glove_lace_edge_y = 5.8;

cable_tie_slot_L = 11.5;
cable_tie_slot_W = 2.8;
cable_tie_slot_r = 1.1;
cable_tie_slot_x = mount_L - 13.0;
cable_tie_slot_y_offset = 4.9;

locator_rail_T = 1.15;
locator_rail_H = 0.90;
locator_clearance = 0.70;
...
front_stop_T = 2.0;
front_stop_H = 1.65;
front_stop_side_gap = 6.0;

lock_tab_W = 16.0;
lock_tab_T = 1.8;
lock_tab_H = 5.8;
lock_tab_back_gap = 0.45;
lock_tooth_W = 11.5;
lock_tooth_T = 1.35;
lock_tooth_H = 1.25;
lock_tooth_z = 3.55;
...
module rear_snap_latch() {
    ...
    translate([
        mount_L / 2 - lock_tab_W / 2,
        tab_y + lock_tab_T - 0.05,
        mount_H + lock_tab_H - 2.10
    ])
        rounded_prism([lock_tab_W, 1.20, 2.10], 0.55);
}
